        ...
        <GlassCard className="!p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-slate-800 dark:text-white">{dashboardStats.totalProjects}</p>
            </div>
        ...
        <GlassCard className="!p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600 dark:text-green-400">{dashboardStats.activeProjects}</p>
            </div>
        ...
        <GlassCard className="!p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-slate-800 dark:text-white">{formatCurrency(dashboardStats.totalRevenue)}</p>
            </div>
        ...
        <GlassCard className="!p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-red-600 dark:text-red-400">{formatCurrency(dashboardStats.totalDue)}</p>
            </div>
              ...
              <GlassCard key={project.id}>
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-sm mb-1 text-slate-600 dark:text-white">{project.client_name}</p>
                ...
                <div className="mt-4 pt-4 space-y-2 border-t border-white/30 dark:border-slate-600/30">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-slate-500 dark:text-white">Paid:</span>
                    <span className="font-semibold text-green-700 dark:text-green-400">{formatCurrency(stats.paidAmount)}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-slate-500 dark:text-white">Due:</span>
                    <span className="font-semibold text-red-700 dark:text-red-400">{formatCurrency(stats.dueAmount)}</span>
                  </div>
                  <div className="flex justify-between items-center text-md">
                    <span className="font-bold text-slate-600 dark:text-white">Total:</span>
                    <span className="font-bold text-slate-800 dark:text-white">{formatCurrency(project.total_amount)}</span>
                  </div>
                </div>
              </GlassCard>
            );
